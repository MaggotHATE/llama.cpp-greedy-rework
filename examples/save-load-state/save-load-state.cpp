...
int main(int argc, char ** argv) {
    ...
    llama_sampler_chain_add(smpl, llama_sampler_init_post(params.sparams.seed));
    ...
    llama_sampler_chain_add(smpl2, llama_sampler_init_post(params.sparams.seed));
    ...
    llama_sampler_chain_add(smpl3, llama_sampler_init_post(params.sparams.seed));
